      ...
      <div className="container mx-auto px-8 max-w-sm sm:max-w-xl md:max-w-5xl left-2 right-2">
              ...
              >
                <div className="grid grid-cols-1 lg:grid-cols-2">
                  <div className="relative group">
                    ...
                    />
                    <div className="absolute inset-0 bg-linear-to-t from-slate-900/80 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-center p-6">
                  ...
                  <div className="p-8">
                    ...
                    <div className="flex space-x-4">
                      ...
                      <a
                        ...
                        target="_blank"
                        rel="noopener noreferrer"
                        className="flex items-center px-4 py-2 bg-linear-to-r from-blue-500 to-orange-500 rounded-lg hover:from-blue-600 hover:to-orange-600 transition-all"
                      >
        ...
        <div className="relative text-center mt-16 pointer-events-auto">
          ...
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="inline-flex items-center bg-linear-to-r from-blue-500 to-orange-500 hover:from-blue-600 hover:to-orange-600 px-6 py-3 rounded-full transition-all"
          >
